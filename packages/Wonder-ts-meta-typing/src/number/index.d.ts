 ...
 * Add<1386, 335> => 1721
 */
export type Add<N1 extends number, N2 extends number> = StrNum.ToNumber<StrNum.Add<StrNum.FromNumber<N1>, StrNum.FromNumber<N2>>>;
/**
 ...
 * Subtract<5, 8> => never
 */
export type Subtract<N1 extends number, N2 extends number> = N1 extends never ? never : N2 extends never ? never : StrNum.ToNumber<StrNum.Subtract<StrNum.FromNumber<N1>, StrNum.FromNumber<N2>>>;
/**
 ...
 * Min<-4, 4> => never
 */
export type Min<N1 extends number, N2 extends number> = N1 extends never ? never : N2 extends never ? never : Subtract<N1 & U.Check<N1>, N2 & U.Check<N2>> extends never ? N1 : N2;
/**
 ...
 * Max<-4, 4> => never
 */
export type Max<N1 extends number, N2 extends number> = N1 extends never ? never : N2 extends never ? never : Subtract<N1, N2> extends never ? N2 : N1;
/**
 ...
 * Equal<8, 9> => false
 */
export type Equal<N1 extends number, N2 extends number> = N1 extends N2 ? N2 extends N1 ? true : false : false;
/**
 ...
 * NotEqual<8, 9> => true
 */
export type NotEqual<N1 extends number, N2 extends number> = N1 extends N2 ? N1 extends N2 ? false : true : true;
/**
 ...
 */
export type GreaterThanOrEqual<N1 extends number, N2 extends number> = Subtract<N1, N2> extends never ? false : true;
/**
 ...
 */
export type GreaterThan<N1 extends number, N2 extends number> = N1 extends N2 ? false : GreaterThanOrEqual<N1, N2>;
/**
 ...
 * LessThan<3, 7> => true
 */
export type LessThan<N1 extends number, N2 extends number> = Subtract<N1, N2> extends never ? true : false;
/**
 ...
 */
export type LessThanOrEqual<N1 extends number, N2 extends number> = N1 extends N2 ? true : LessThan<N1, N2>;
/**
 ...
 * InRange<5, 5, 10> => true
 */
export type InRange<N extends number, L extends number, H extends number> = GreaterThanOrEqual<N, L> & LessThanOrEqual<N, H> extends never ? false : true;
/**
 ...
 * Mult<3, 18> => 54
 */
export type Mult<N1 extends number, N2 extends number> = N1 extends 0 ? 0 : N2 extends 0 ? 0 : N1 extends 1 ? N2 : N2 extends 1 ? N1 : StrNum.ToNumber<StrNum.Mult<StrNum.FromNumber<N1>, StrNum.FromNumber<N2>>>;
/**
 ...
 * DivMod<9, 3> => [3, 0]
 */
export type DivMod<N1 extends number, N2 extends number> = N2 extends 0 ? never : N1 extends 0 ? [0, 0] : N1 extends N2 ? [1, 0] : StrNum.Divide<StrNum.FromNumber<N1>, StrNum.FromNumber<N2>> extends [
	infer Q,
	infer R
] ? [StrNum.ToNumber<string & Q>, StrNum.ToNumber<string & R>] : never;
/**
 ...
 * Div<14, 5> => 2
 */
export type Div<N1 extends number, N2 extends number> = N2 extends 0 ? never : N1 extends 0 ? 0 : N1 extends N2 ? 1 : StrNum.ToNumber<StrNum.Divide<StrNum.FromNumber<N1>, StrNum.FromNumber<N2>>[0]>;
 ...
 * Mod<14, 5> => 4
 */
export type Mod<N1 extends number, N2 extends number> = N2 extends 0 ? never : N1 extends 0 ? 0 : N1 extends N2 ? 0 : StrNum.ToNumber<StrNum.Divide<StrNum.FromNumber<N1>, StrNum.FromNumber<N2>>[1]>;
// /**
...
//  * Pow<3, 4> => 81
//  */
// export type Pow<N1 extends number, N2 extends number> = N1 extends 0 ? 0 : N2 extends 0 ? 1 : N2 extends 1 ? N1 : N2 extends 2 ? Mult<N1, N1> : IsEven<N2> extends true ? Pow<Mult<N1, N1>, Div<N2, 2>> : Mult<N1, Pow<N1, Decr<N2>>>;
