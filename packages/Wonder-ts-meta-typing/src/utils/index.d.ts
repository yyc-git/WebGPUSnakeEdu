 ...
 */
export type Extends<A, B, Then = true, Else = false> = A extends B ? Then : Else;
/**
 * If A does not extend B, returns Then (default true) or else Else (default false)
 */
export type NotExtends<A, B, Then = true, Else = false> = A extends B ? Else : Then;
/**
 ...
 * Not<boolean> => never
 */
export type Not<V extends boolean> = boolean extends V ? never : V extends true ? false : true;